...
void launch_attention_kernel(
    ...
    if (seq_len_k < 24) {
       ...
       hipLaunchKernelGGL(( attention_kernel_64<head_dim, chunk_size, n_warps>), dim3(dim3(blocks)), dim3(dim3(threads)), shared_mem_size, 0, 
       ...
       hipLaunchKernelGGL(( attention_kernel_256<head_dim, chunk_size, chunk_size_k, n_warps>), dim3(dim3(blocks)), dim3(dim3(threads)), shared_mem_size, 0, 
            batch_size, seq_len_q, seq_len_k, num_features, 
            queries, keys, values, mask, output
        );
    }
...
void launch_attention_trans_kernel(
    ...
    if (seq_len_k < 24) {
       ...
       hipLaunchKernelGGL(( attention_trans_kernel_64<head_dim, chunk_size, n_warps>), dim3(dim3(blocks)), dim3(dim3(threads)), shared_mem_size, 0, 
            batch_size, seq_len_q, seq_len_k, num_features, 
            queries, keys, values, mask, output
        );
    } else {
       ...
       hipLaunchKernelGGL(( attention_trans_kernel_256<head_dim, chunk_size, chunk_size_k, n_warps>), dim3(dim3(blocks)), dim3(dim3(threads)), shared_mem_size, 0, 
            batch_size, seq_len_q, seq_len_k, num_features, 
            queries, keys, values, mask, output
        );
    }
